...
public class SodaQR_android extends SodaQR implements SodaContext {
	 ...
	 * @return
	 */
	public static SodaQR_android create() {

		SodaQR_android ctxQR = new SodaQR_android();
	 ...
	 * @return
	 */
	public static SodaQR_android create(String Data) {
	 ...
	 * @return
	 */
	public static SodaQR_android fromImageData(byte[] b) {


		SodaQR_android newQR = new SodaQR_android();
		try {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof SodaQR_android)) {
			return false;
		}
		SodaQR_android qr = (SodaQR_android) obj;
	...
	public ImageContainer getImg_() {
		...
		super.img_.setQrBitCodeImage_(this.qrCodeImage_);
		return super.img_;
	}
